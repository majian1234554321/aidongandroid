            ...
            public boolean onPressToSpeakBtnTouch(View v, MotionEvent event) {
                ...
                if (ContextCompat.checkSelfPermission(getActivity(), permission)
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), permission)) {
                        ActivityCompat.requestPermissions(getActivity(), new String[]{permission}, REQUEST_PERMISSION_CODE);
                    } else {
...
//                        showPermissionDailog(permission, "请打开读取权限,以正常使用应用");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(getActivity(), "录音权限被禁用，需要手动打开，请进入设置应用管理打开权限", Toast.LENGTH_SHORT).show();
        }
