package com.example.aidong.module.chat.db;
...
import com.example.aidong .module.chat.db.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager() {
        dbHelper = DbOpenHelper.getInstance(App.mInstance.getApplicationContext());
    }
