...
import com.example.aidong.widget.tabLayout.listener.ICustomTab;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private ArrayList<ICustomTab> mTabs = new ArrayList<>();
    ...
    public void setTabData(ArrayList<ICustomTab> tabs) {
        if (tabs == null || tabs.size() == 0) {
            throw new IllegalStateException("Tab can not be NULL or EMPTY !");
        }
        this.mTabs.clear();
    ...
    /** 关联数据支持同时切换fragments */
    public void setTabData(ArrayList<ICustomTab> tabs, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    private void addTab(final int position, View tabView) {
        ...
        tv_tab_title.setText(mTabs.get(position).getTabTitle());
        ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
        iv_tab_icon.setImageResource(mTabs.get(position).getTabUnselectedIcon());
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (mIconVisible) {
                ...
                ICustomTab tabEntity = mTabs.get(i);
    ...
    *//**
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (mIconVisible) {
                if (iconH <= 0) {
                    iconH = mContext.getResources().getDrawable(mTabs.get(position).getTabSelectedIcon()).getIntrinsicHeight();
                }
                margin = mIconMargin;
            }
