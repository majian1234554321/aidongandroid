...
public class ZoomImageView extends View implements Observer {
	...
	public BasicZoomListener mZoomListener;
	private boolean singleTap = false;
	private SingleTapListener singleTapListener;
	private FillingListener fillingListener;
	private byte moveShortTimeCount = 0;
	...
	public void setSingleTapListener(SingleTapListener s){
		singleTapListener = s;
	}
	
	public void setFillingListener(FillingListener l){
		fillingListener = l;
	}
...
//			Log.d("ZoomImageView", "mRectDst.right" + mRectDst.right);
	...
	private Runnable moveRunnable = new Runnable() {
		...
		public void run() {
			...
			handler.removeCallbacks(moveRunnable);
			if(!singleTap){
				if(fillingListener != null){
					fillingListener.onFilling(mZoomListener.short_dx);
				}
			}
		}
	};
	
	public class BasicZoomListener implements OnTouchListener {

		/** Zoom control to manipulate */
		private BasicZoomControl mZoomControl;

		public float mFirstX = -1;
		public float mFirstY = -1;
		public float mSecondX = -1;
		public float mSecondY = -1;
		
		public float short_dx;

		public int mOldCounts = 0;
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			case MotionEvent.ACTION_DOWN:
				...
				mFirstY = event.getY();
				singleTap = true;
				handler.postDelayed(moveRunnable, 300);
				return true;
			case MotionEvent.ACTION_MOVE: 
				...
				if (1 == nCounts) {
					...
					Log.e(TAG, "mOldCounts = "+mOldCounts);
					Log.e(TAG, "dx = "+dx);
