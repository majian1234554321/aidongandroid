...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<CourseBeanNew> dataList;
    ...
    public SectionDecoration(List<CourseBeanNew> dataList, Context context, DecorationCallback decorationCallback) {
        Resources res = context.getResources();
        this.dataList = dataList;
        this.callback = decorationCallback;
        //设置悬浮栏的画笔---paint
        paint = new Paint();
        paint.setColor(res.getColor(R.color.main_background));
