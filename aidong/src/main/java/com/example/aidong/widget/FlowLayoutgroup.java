...
public class FlowLayoutgroup extends ViewGroup {
    ...
    public FlowLayoutgroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayoutgroup(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs,
                R.styleable.FlowLayoutgroup);
        lineSpacing = mTypedArray.getDimensionPixelSize(
                R.styleable.FlowLayoutgroup_lineSpacing, 0);
        mTypedArray.recycle();
    }
