...
import com.example.aidong .ui.video.fragment.DeepIntoFragment;
...
public class DeepIntoAdapter extends RecyclerView.Adapter<DeepIntoAdapter.ViewHolder> {
    ...
    public DeepIntoAdapter(Context context, OnItemClickListener listener) {
        mContext = context;
        mListener = listener;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            case TYPE_FOOTER:
                ...
                break;
            case TYPE_ITEM:
                view = LayoutInflater.from(mContext).inflate(R.layout.item_speciaal_topic, viewGroup, false);
                break;
        }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int i) {
        ...
        switch (holder.getItemViewType()) {
            ...
            case TYPE_ITEM:
                ...
                //                    isFirst = false;
                if (indexs.contains(i) || DeepIntoFragment.scrollDirection == 0) {
