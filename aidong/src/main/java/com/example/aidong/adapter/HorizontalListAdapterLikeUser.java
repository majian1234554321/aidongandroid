...
public class HorizontalListAdapterLikeUser extends AbstractCommonAdapter {
	private Context context;
	ArrayList<AttributeDynamics.LikeUser> array;
	private String TAG = "ListAdapterActivities";
	
	public HorizontalListAdapterLikeUser(Context context) {
	...
	public HorizontalListAdapterLikeUser(Context context,ArrayList<AttributeDynamics.LikeUser> array) {
		this.context = context;
