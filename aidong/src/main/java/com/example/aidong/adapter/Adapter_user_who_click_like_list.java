...
public class Adapter_user_who_click_like_list extends AbstractCommonAdapter {
	...
	public Adapter_user_who_click_like_list(Context context	) {
...
//	public Adapter_user_who_click_like_list(Context context	,ArrayList<LikeData> array) {
//		this.context = context;
//		isLogin = BaseApp.mInstance.isLogin();
//		this.array = new ArrayList<LikeData>();
