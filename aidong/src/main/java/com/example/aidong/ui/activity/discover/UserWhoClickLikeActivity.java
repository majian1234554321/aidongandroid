...
import com.example.aidong.adapter.LikeListAdapter;
...
import com.example.aidong.entity.model.LikeData;
import com.example.aidong.entity.model.LikeListResult;
...
public class UserWhoClickLikeActivity extends BaseActivity implements
    ...
    protected void setupView() {
        ...
        adapter = new LikeListAdapter(this);
    ...
    protected void initData() {
        addTask(this, new IHttpTask(UrlLink.DYNAMICZAN_URL,
                ...
                LIKE_DOWN);
        adapter.setOnUserLikeClickListener(new LikeListAdapter.OnUserLikeClickListener() {
