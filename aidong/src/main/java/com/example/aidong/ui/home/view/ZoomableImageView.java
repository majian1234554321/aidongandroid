...
public class ZoomableImageView extends View {
    ...
    private class MyGestureListener extends
        ...
        /**
         * 对WebView的图片进行单击，以/单击退出ShowWebImageActiviyt,回到架子WebView所在的MainActivity。
         */

        @Override
        public boolean onSingleTapConfirmed(MotionEvent e) {

            //单击退出ShowWebImageActiviyt,回到架子WebView所在的MainActivity。
            ShowWebImageActivity.showWebImageActivity.finish();
            return true;
        ...
        /**
         * 对webView的图片进行双击，时图片放大，如果图片已经放大，再进行双击时，图片缩小为原状。
         */
