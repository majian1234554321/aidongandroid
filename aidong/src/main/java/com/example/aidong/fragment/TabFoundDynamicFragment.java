...
import com.example.aidong.activity.VideoPlayerActivity;
import com.example.aidong.activity.lovesportcircle.CommentDetailActivity;
...
//			i.putExtra(BaseActivity.BUNDLE_VIDEO_URL, mvideo.getFilm()
//					.getFilm());
