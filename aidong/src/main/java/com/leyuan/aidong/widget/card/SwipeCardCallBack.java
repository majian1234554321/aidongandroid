...
public class SwipeCardCallBack extends ItemTouchHelper.SimpleCallback {
    private ArrayList<CourseBeanNew> courseBeanNews;
    private UniversalAdapter adapter;
    private RecyclerView mRv;

    public SwipeCardCallBack(ArrayList<CourseBeanNew> courseBeanNews, UniversalAdapter adapter, RecyclerView mRv) {
        super(0,
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        CourseBeanNew remove = courseBeanNews.remove(viewHolder.getLayoutPosition());
        courseBeanNews.add(0, remove);
