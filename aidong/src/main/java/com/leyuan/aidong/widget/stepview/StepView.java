package com.leyuan.aidong.widget.stepview;
...
import com.leyuan.aidong.widget.stepview.item.LinearDividerItemDecoration;
import com.leyuan.aidong.widget.stepview.item.StepNodeItemDecoration;
...
public class StepView extends RecyclerView {
    ...
    private class StepAdapter extends Adapter<StepViewHolder> {
        ...
        public void onBindViewHolder(StepViewHolder holder, int position) {
            Object data = itemData.get(position);
            if (listener != null) {
