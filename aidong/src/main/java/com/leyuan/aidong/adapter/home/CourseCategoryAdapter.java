        ...
        switch (itemViewType){
            case TYPE_ONE_IMAGE:
                ...
                ((OneImageHolder)holder).one.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        CourseActivity.start(context,courseBeanList.get(0).getName());
                    }
                });
                break;
            case TYPE_TWO_IMAGE:
                ...
                ((TwoImageHolder)holder).two.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        CourseActivity.start(context,courseBeanList.get(1).getName());
                    }
                });
                break;
            case TYPE_ONE_AND_TWO_IMAGE:
                ...
                ((OneAndTwoImageHolder)holder).three.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        CourseActivity.start(context,courseBeanList.get(2).getName());
                    }
                });
                break;
