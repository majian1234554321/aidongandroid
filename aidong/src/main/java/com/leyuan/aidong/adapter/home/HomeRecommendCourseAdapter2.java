 ...
 */
public class HomeRecommendCourseAdapter2 extends RecyclerView.Adapter<HomeRecommendCourseAdapter2.ViewHolder> {
    ...
    public HomeRecommendCourseAdapter2(Context context) {
