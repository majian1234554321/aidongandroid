...
public class NurturePresentImpl implements NurturePresent{
    ...
    public NurturePresentImpl(GoodsSkuPopupWindowView skuPopupWindow, Context context) {
        this.context = context;
    ...
    public void buyNurtureImmediately(String skuCode, int amount, String pickUp, String pickUpId) {
        nurtureModel.buyNurtureImmediately(new ProgressSubscriber<BaseBean>(context) {
            @Override
