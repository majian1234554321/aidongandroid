package com.leyuan.aidong.ui.activity.home.behavior;
...
public class HeaderBehavior extends CoordinatorLayout.Behavior<View>{
    ...
    private void hide(final View view) {
        ViewPropertyAnimator animator = view.animate().translationY(-view.getHeight()).setInterpolator(INTERPOLATOR).setDuration(300);
