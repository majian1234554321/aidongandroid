...
public class EquipmentPresentImpl implements EquipmentPresent{
    ...
    private GoodsSkuPopupWindowView skuPopupWindow;
    ...
    public EquipmentPresentImpl(GoodsSkuPopupWindowView skuPopupWindow, Context context) {
        this.context = context;
    ...
    public void buyEquipmentImmediately(String skuCode, int amount, String pickUp, String pickUpId) {
        equipmentModel.buyEquipmentImmediately(new ProgressSubscriber<BaseBean>(context) {
            @Override
            public void onNext(BaseBean baseBean) {
                //skuPopupWindow.buyGoodsImmediatelyResult(baseBean);
            }
