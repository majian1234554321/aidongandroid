 ...
 * //todo 混乱.............
 */
public class CourseListFilterView extends LinearLayout implements View.OnClickListener {
    ...
    public CourseListFilterView(Context context) {
        this(context, null);
    }

    public CourseListFilterView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CourseListFilterView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        View view = LayoutInflater.from(context).inflate(R.layout.view_course_list_filter, this);
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_filter:
                if (onFilterClickListener != null) {
                    //全部课程类型返回空
                    onFilterClickListener.onFilterItemClick();
                }
                break;
            default:
                break;
