 ...
 */
public class LoveSportPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link LoveSportPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link LoveSportPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(LoveSportPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link LoveSportPlayer#onRenderers} or
     * {@link LoveSportPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
  ...
  public LoveSportPlayer(RendererBuilder rendererBuilder) {
   ...
   *
   * @param renderers Renderers indexed by {@link LoveSportPlayer} TYPE_* constants. An individual
