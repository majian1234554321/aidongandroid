...
public class SelectedUserActivity extends BaseActivity implements SearchHeaderView.OnSearchListener, SelectedCircleView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followPresent = new FollowPresentImpl(this);
//        followPresent.getFollowUserList(1);
//        followPresent.getFollowCoachesList(1);
//        followPresent.getFollowCoursesList(1);
//        followPresent.getFollowCampaignsList(1);
