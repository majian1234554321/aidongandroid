...
public class PreviewVideoActivity extends Activity implements TextureView
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
     ...
     String  vodieUrl =   getIntent().getStringExtra("vodieUrl");
        ...
        startPlayVideo("http://image.aidong.me/video/190092_1525693837721*w=720_h=1280.m3u8", mediaWidth, mediaHeight, originLeft, originTop, originWidth, originHeight, rotateAngle);
    }
