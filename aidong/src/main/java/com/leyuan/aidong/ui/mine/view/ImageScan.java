...
public abstract class ImageScan {
    ...
    private ArrayList<AlbumFolderInfoBean> mFolderList;
    ...
    private void startScanImg(LoaderManager loaderManager, final Context context) {
        ...
        LoaderManager.LoaderCallbacks<Cursor> loaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
            ...
            public Loader<Cursor> onCreateLoader(int id, Bundle args) {
                CursorLoader imageCursorLoader = new CursorLoader(context,
                        MediaStore.Images.Media.EXTERNAL_CONTENT_URI,IMAGE_PROJECTION, null, null, MediaStore.Images.Media.DEFAULT_SORT_ORDER);
            ...
            public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
                if (data.getCount() == 0) {
                    Toast.makeText(context, "没有扫描到图片", Toast.LENGTH_LONG).show();
                } else {
                    ...
                    if (albumFolderList != null && albumFolderList.size() > 0 && albumImageListMap != null) {
                        ...
                        ArrayList<AlbumFolderInfoBean> albumFolderInfoList = new ArrayList<>();

                        AlbumFolderInfoBean allImageFolder = createAllImageAlbum(context, albumImageListMap);
                        ...
                        for (int albumFolderPos = 0; albumFolderPos < albumFolderSize; albumFolderPos++) {
                            ...
                            AlbumFolderInfoBean albumFolderInfo = new AlbumFolderInfoBean();
     ...
     * @return
     */
    private AlbumFolderInfoBean createAllImageAlbum(Context context, Map<String, ArrayList<File>> albumImageListMap) {
    ...
    public abstract void onScanFinish(ArrayList<AlbumFolderInfoBean> folderList);
