...
public class CourseVideoDetailActivityNew extends BaseActivity implements SportCircleFragmentView,CourseDetailActivityView, View.OnClickListener {
...
//        }
    ...
    private class DynamicCallback extends CircleDynamicAdapter.SimpleDynamicCallback {
        ...
        public void onBackgroundClick(int position) {
            CourseVideoDetailActivityNew.this.clickPosition = position;
            if (App.mInstance.isLogin()) {
                startActivityForResult(new Intent(CourseVideoDetailActivityNew.this, DynamicDetailActivity.class)
                        .putExtra("dynamic", dynamicList.get(position)), REQUEST_REFRESH_DYNAMIC);
            } else {
                invokeDynamicBean = dynamicList.get(position);
                startActivityForResult(new Intent(CourseVideoDetailActivityNew.this, LoginActivity.class), REQUEST_TO_DYNAMIC);
            }
        }

        @Override
        public void onAvatarClick(String id) {
            UserInfoActivity.start(CourseVideoDetailActivityNew.this, id);
        }

        @Override
        public void onVideoClick(String url) {
            Intent intent = new Intent(CourseVideoDetailActivityNew.this, PlayerActivity.class)
        ...
        public void onImageClick(List<String> photoUrls, List<Rect> viewLocalRect, int currPosition) {
            ...
            PhotoBrowseActivity.start((Activity) CourseVideoDetailActivityNew.this, info);
        }
        ...
        public void onLikeClick(int position, String id, boolean isLike) {
            if (App.mInstance.isLogin()) {
                ...
                startActivityForResult(new Intent(CourseVideoDetailActivityNew.this, LoginActivity.class), REQUEST_LOGIN);
            }
        }
...
//            }
        ...
        public void onCommentListClick(DynamicBean dynamicBean, int position, CommentBean item) {
            CourseVideoDetailActivityNew.this.clickPosition = position;
            if (App.mInstance.isLogin()) {
                startActivityForResult(new Intent(CourseVideoDetailActivityNew.this,
