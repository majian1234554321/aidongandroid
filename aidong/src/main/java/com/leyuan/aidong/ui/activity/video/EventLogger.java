 ...
 */
public class EventLogger implements LoveSportPlayer.Listener, LoveSportPlayer.InfoListener,
    LoveSportPlayer.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[LoveSportPlayer.RENDERER_COUNT];
  }
