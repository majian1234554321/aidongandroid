package com.leyuan.aidong.module.photopicker.adapter;
...
import com.leyuan.aidong.module.photopicker.entity.LocalMedia;
import com.leyuan.aidong.module.photopicker.utils.FunctionConfig;
import com.leyuan.aidong.module.photopicker.utils.LocalMediaLoader;
import com.leyuan.aidong.module.photopicker.utils.OptAnimationLoader;
...
public class PhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PhotoAdapter(Context context, boolean showCamera, int maxSelectNum, int mode, boolean enablePreview, boolean enablePreviewVideo, int cb_drawable, boolean is_checked_num) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (type == LocalMediaLoader.TYPE_VIDEO) {
               ...
               /* Glide.with(context)
                ...
                contentHolder.picture.setImageURI("file:///" + path);
    ...
    private void changeCheckboxState(ViewHolder contentHolder, LocalMedia image) {
        ...
        if (selectImages.size() >= maxSelectNum && !isChecked) {
            Toast.makeText(context,"超过数量", Toast.LENGTH_LONG).show();
            return;
        }
        if (isChecked) {
            for (LocalMedia media : selectImages) {
