...
package com.leyuan.aidong.module.photopicker.boxing_impl.record.camera;
...
public class CameraWrapper {
    ...
    public void configureForPreview(int viewWidth, int viewHeight) {
        ...
        final CameraSize previewSize = getOptimalSize(params.getSupportedPreviewSizes(), viewHeight,viewWidth);
