package com.leyuan.support.widget.dropdownmenu.adapter;
...
public class ListDropDownWithFlagAdapter extends BaseAdapter {
    ...
    public ListDropDownWithFlagAdapter(Context context, List<String> list) {
